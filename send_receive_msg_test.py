...
if __name__ == '__main__':
    ...
    private_key_info1, public_key_info1 = generate_keys('name', 'email', 'ElGamal', 1024, 'passphrase')
    ...
    msgBuilder1.zip()
    msgBuilder1.encrypt('DES3', public_key_info1['public_key'], public_key_info1['key_id'], public_key_info1['algorithm'])
    ...
    if msgReceiver1.is_encripted():
        ...
        msgReceiver1.decrypt(private_key_info1['private_key'], 'passphrase')
